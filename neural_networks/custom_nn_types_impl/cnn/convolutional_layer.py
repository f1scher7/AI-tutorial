...
class ConvolutionLayer:
    ...
    def __init__(self, input_shape, filters_num, filter_size, filter_init_func_name='he', stride=1, padding=0, feature_map_activation_func='relu'):
        """
        ...
        self.biases = biases_initialization_func(bias_len=self.filters_num, func_name=self.feature_map_activation_func)
